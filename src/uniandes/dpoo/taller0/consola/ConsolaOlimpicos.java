...
import uniandes.dpoo.taller0.modificaciones.Modificacion;
...
public class ConsolaOlimpicos
{
	...
	public void ejecutarAplicacion()
	{
		...
		while (continuar)
		{
			try
			{
				...
				else if (opcion_seleccionada == 15 && calculadora != null)
					ejecutarNuevaClase();
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar pais atleta"); 
		System.out.println("15. Crear nuevo programa");
	}
    ...
    public void ejecutarBuscarAtletaPais() {
    	String nombreAtleta = input("ingrese el nombre del atleta que desea buscar: "); 
    	String paisAtleta = calculadora.paisAtleta(nombreAtleta); 
    	System.out.println("El nombre del pais del atleta es:"+ paisAtleta);
    }
    public void ejecutarNuevaClase(){ 
